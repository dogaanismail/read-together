...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CustomError> handleUserAlreadyExistException(UserAlreadyExistException ex) {
    ...
    public ResponseEntity<CustomError> handlePasswordNotValidException(PasswordNotValidException ex) {
        log.error("Invalid password: {}", ex.getMessage());
        
        CustomError error = CustomError.builder()
                .httpStatus(HttpStatus.BAD_REQUEST)
                .header(CustomError.Header.VALIDATION_ERROR.getName())
                .message("Password validation failed: " + ex.getMessage())
                .build();
    ...
    private CustomError.CustomSubError createSubError(FieldError fieldError) {
